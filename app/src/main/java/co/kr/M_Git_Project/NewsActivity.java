...
public class NewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = (ImageView)findViewById(R.id.card_image1);
        ...
        type_check = intent3.getIntExtra("type",1);
         // 임시 확인용 변수, 1,2로 뉴스레터와 직업 카드를 각각 확인,
        switch(type_check){
            case 0:init_haeseong_notice_card(); break; // 해성공지
            ...
            case 6:init_capstone_card(); break; // 캡스톤 디자인
