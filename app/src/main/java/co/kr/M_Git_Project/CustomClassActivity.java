            ...
            public void onClick(View v) {
                 switch (result){
                     ...
                     case "F":
                         ...
                         submanual2.setText("정보\n\n- 실험실습\n- 김기원 교수님\n- 3학점\n- 중간평가:30/기말평가:38\n- 과제:16/출석:16\n\n");
                         submanual2.requestLayout();
                         submanual3.setText("- 프로젝트를 한 번 해보고 싶었다면? 이 과목입니다! 꽤 새로운 경험이었어요.\n" +
                                 "- 부품 다루는게 쉽지 않네요.. 잘 안맞으면 어려운 과목입니다");
                         submanual3.requestLayout();
                         break;
                     case "G":
                ...
                switch (result){
                    ...
                    case "C":
                        manual.setText("*네트워크 프로그램 설계\n\n" +
                                "수업 개요 \n통신 프로토콜에 대한 기본 이론을 습득하고, 이를 바탕으로 통신 응용 프로그램을 작성할 수 있는 소양을 키운다. 정보통신망과 인터넷에 대한 기초 이론을 기반으로, 유닉스 시스템 프로그래밍과 네트워크 프로그래밍을 결합하여 정보통신 응용프로그램 개발 능력을 배양한다.\n" +
                                "\n" +
                    ...
                    case "F":
                        manual.setText("*논리회로\n\n" +
                                "수업 개요 \n디지털 논리회로의 기본적인 논리 게이트들의 특성, 플립플롭의 특성, 카운터, 레지스터의 기본 특성을 이해, 조합 논리와 순차회로를 해석하여 원하는 디지털 논리회로 설계 학습\n 아두이노 우노와 센서, 입출력 장치 등을 이용하여 기본적인 디지털 회로 설계 실습\n" +
                                "\n" +
                    ...
                    case "G":
                        ...
                        submanual2.setText("정보\n\n- 실험실습\n- 김치연 교수님\n- 3학점\n- 중간평가:30/기말평가:30\n- 실험실습 실기:10/과제:14/출석:16\n\n");
                        submanual2.requestLayout();
                        submanual3.setText("- 웹 프로그래밍을 했었고 나 좀 치는데? 싶다고 들었다가 큰 코 다칩니다! 어려워요! :(\n" +
                                "- 뒤로 갈수록 어렵긴 한데 웹 디자이너를 꿈꾼다면 꼭 들어야 한다 생각해요.. \n");
                        submanual3.requestLayout();
                        break;
                    case "H":
                        break;
                ...
                switch (result){
                    ...
                    case "C":
                        manual.setText("*UNIX 및 실습\n\n" +
                                "수업 개요 \nUNIX(LINUX)환경에서 필요한 기본 명령과 유틸리티 및 개발도구를 익히고 이를 바탕으로 스크립트 프로그래밍 능력을 배양한다. 주로 리눅스 표준 디렉터리, 셸의 기능과 기본 명령어, 리눅스의 부팅 사용자 계정의 관리, 텍스트 편집, 파일 시스템과 프로세스의 관리, 패키지 관리, 셸 스크립트, 네트워크 설정 및 서버를 학습하고 이해한다.\n" +
                                "\n" +
                ...
                switch (result){
                    ...
                    case "C":
                        manual.setText("*컴퓨터 네트워크\n\n" +
                                "수업 개요 \nOSI 7계층을 기본으로 하위 물리계층부터 상위 응용 계층까지, 데이터 통신 및 네트워크 관련 이론을 교수하며, 이를 바탕으로 인터넷에서 사용되는 서비스 프로토콜들을 이해하고 학습할 수 있다.\n" +
                                "\n" +
