...
public class CreatePostActivity extends AppCompatActivity {
        ...
        if (intent != null && intent.hasExtra("post") && intent.getBooleanExtra("isEdit", false)) {
            ...
            registerButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (index != -1) {
                        OnlineBoardActivity.testDataSet.set(index, editPost);
                        OnlineBoardActivity.customAdapter.notifyDataSetChanged();
                    }
            ...
            registerButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    int id = OnlineBoardActivity.testDataSet.size(); // 새로운 ID 할당
    ...
    private int findPostIndexById(int postId) {
        for (int i = 0; i < OnlineBoardActivity.testDataSet.size(); i++) {
            if (OnlineBoardActivity.testDataSet.get(i).getPost_id() == postId) {
                return i;
            }
        }
        return -1;
